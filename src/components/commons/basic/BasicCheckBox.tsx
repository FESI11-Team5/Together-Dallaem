...
export default function BasicCheckBox({
	...
	return (
		<div
			className={`flex h-[70px] w-full max-w-[160px] cursor-pointer items-start gap-2 rounded-[8px] border-2 ${isChecked ? 'border-primary-400 shadow-primary-500/50 shadow-lg' : 'border-black'} ${isLarge ? 'pt-[12px] pr-[20px] pb-[16px] pl-[16px]' : 'pt-[6px] pr-[20px] pb-[30px] pl-[6px]'}`}
			onClick={handleClick}>
