...
export default function Chip({ text, isActive = false, imgUrl, onClick }: ChipProps) {
	return (
		<div className="group relative flex cursor-pointer items-center gap-2">
			...
			<div
				className={`mb:px-[16px] mb:py-[10px] relative box-border flex h-10 cursor-pointer items-center gap-2 rounded-[12px] px-[12px] py-[8px] leading-none transition duration-400 ${isActive ? 'bg-primary-500 text-white' : 'border-2 border-gray-500 text-gray-50'}`}
				onClick={onClick}>
