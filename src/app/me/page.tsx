...
const MYPAGE_TITLE_GLOW =
	'[text-shadow:0_0_2px_#05F2DB,0_0_4px_#05F2DB,0_0_8px_#05F2DB,0_0_16px_#05F2DB,0_0_0_#05F2DB]';
	...
	return (
		<div className="box-border" style={{ fontFamily: 'var(--font-pretendard)' }}>
			<div className="tb:px-6 tb:pt-8 pc:max-w-300 pc:px-25 bg-root m-auto flex min-h-[calc(100vh-60px)] flex-col px-4 pt-6">
				<h1 className={`text-primary-100 mb-4 text-lg font-semibold ${MYPAGE_TITLE_GLOW}`}>마이페이지</h1>
				<ProfileEditCard />
				<MyActivityContainer />
			</div>
		</div>
